...
<body >
    ...
    <form method="post">
            <table>
                <tr>
                    ...
                    if(isset($_POST['search']))
                    {
                        ...
                        $p = "SELECT * From `userfeedback` where `name` LIKE '%$searchKey%'";

                    }
                    else
                    {
                        $p = "SELECT * From `userfeedback`";
                        $searchKey = "";
                    }
            ...
            ?>
                <tr>
                    <td style="padding-left: 20px;"><span style="font-weight: bold; font-size: 15px;"><?php echo $loc['email']?></span></td>
                    <td><div class="test"><?php echo $loc['type']?></div></td>
                    <td><?php echo $loc['feedback']?></td>
                    <td><?php 
                    if($loc['review'] == 5)
                    {
