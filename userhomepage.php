				...
				<div class="row">
					<div class="col-md-12">
						<ul id="fh5co-destination-list" class="animate-box">
							<li class="one-forth text-center" style="background-image: url(images/sarawak.jpg); ">
								<a href="#">
							...
							<li class="one-forth text-center" style="background-image: url(images/sabah.jpg); ">
								<a href="#">
									<div class="case-studies-summary">
										<h2>Sabah</h2>
									</div>
							...
							<li class="one-forth text-center" style="background-image: url(images/perak.jpg); ">
								<a href="#">
									<div class="case-studies-summary">
										<h2>Perak</h2>
									</div>
							...
							<li class="one-forth text-center" style="background-image: url(images/kuala\ lumpur.jpg); ">
								<a href="#">
									<div class="case-studies-summary">
										<h2>Kuala Lumpur</h2>
									</div>
							...
							<li class="one-forth text-center" style="background-image: url(images/terengganu.jpg); ">
								<a href="#">
									<div class="case-studies-summary">
										<h2>Terengganu</h2>
									</div>
							...
							<li class="one-forth text-center" style="background-image: url(images/kedah.jpg); ">
								<a href="#">
									<div class="case-studies-summary">
										<h2>Kedah</h2>
									</div>
							...
							<li class="one-forth text-center" style="background-image: url(images/perlis.jpg.jpg); ">
								<a href="#">
									<div class="case-studies-summary">
										<h2>Perlis</h2>
									</div>
							...
							<li class="one-forth text-center" style="background-image: url(images/negeri\ sembilan.jpg); ">
								<a href="#">
									<div class="case-studies-summary">
							...
							<li class="one-forth text-center" style="background-image: url(images/penang.jpg); ">
								<a href="#">
									<div class="case-studies-summary">
										<h2>Penang</h2>
									</div>
